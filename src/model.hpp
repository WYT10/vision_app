...
struct RoiRuntimeData {
    ...
    cv::Rect dynamic_left_zone_rect;
    cv::Rect dynamic_right_zone_rect;
    ...
    int red_center_x = -1;
    int left_zone_center_x = -1;
    int right_zone_center_x = -1;
    int red_blob_area = 0;
    int red_pixels = 0;
    int left_zone_red_pixels = 0;
    int right_zone_red_pixels = 0;
    int left_zone_valid_pixels = 0;
    int right_zone_valid_pixels = 0;
    double left_zone_red_ratio = 0.0;
    double right_zone_red_ratio = 0.0;
    bool red_found = false;
    bool left_zone_found = false;
    bool right_zone_found = false;
    bool left_zone_passed = false;
    bool right_zone_passed = false;
    bool band_passed = false;
    bool dual_zone_triggered = false;
