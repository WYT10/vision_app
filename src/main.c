...
static void print_help() {
    std::cout
        ...
        << "  ./vision_app --mode calibrate --device /dev/video0 --width 640 --height 480 --fourcc MJPG --fps 120 --warp-width 384 --warp-height 384 --target-tag-px 128\n"
